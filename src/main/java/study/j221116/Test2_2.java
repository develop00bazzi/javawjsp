...
//		서버에서 get 방식으로의 전송 방법
		...
		response.sendRedirect(request.getContextPath()+"/study/221116/test2Ok.jsp?hakbun="+hakbun+"&name="+name+"&kor="+kor+"&eng="+eng+"&mat="+mat+"&soc="+soc+"&sci="+sci+"&tot="+tot+"&avg="+avg+"&grade="+grade);
	}
}
