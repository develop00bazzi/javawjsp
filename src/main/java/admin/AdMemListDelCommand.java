...
public class AdMemListDelCommand implements AdminInterface {
...
//		3. 총 레코드 건수를 구한다.
		int totRecCnt=dao.getTotMemDelRecCnt();
...
//		ArrayList<GuestVO> vos=dao.getGuestList();
		ArrayList<MemberVO> vos=dao.getMemDelList(startIndexNo,pageSize);	// 하나의 메소드를 이용하여 관리자와 일반회원의 조회를 한번에 처리
