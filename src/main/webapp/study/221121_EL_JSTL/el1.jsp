...
<div class="container">
	...
	<%
		...
		// 앞의 데이터가 컨트롤러(서비스)객체에서 저장소를 통해서 넘겨주었을 경우에는 EL을 통해서 바로 받을 수 있다.
	...
	<h4>JSP에서 폼 태그(GET/POST)로 넘긴 자료를 JSP로 바로 받을때</h4>
	...
	<h4>JSP에서 폼 태그(GET/POST)로 넘긴 자료를 서블릿을 통해서 받을때</h4>
