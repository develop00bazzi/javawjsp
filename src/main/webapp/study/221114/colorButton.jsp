...
<div class="container">
	...
	<div class="container">
		...
		<button class="btn w3-black w3-hover-yellow">Button Button</button>
		<a href="#" class="btn w3-black w3-hover-blue">Link Button</a>
		<hr/><br/>
		<div style="width:600px; height:200px;" class="w3-yellow">
			이곳은 내용 영역입니다.
		</div>
	</div>
</div>
