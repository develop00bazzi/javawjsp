...
<head>
	...
	<script>
		...
		let lastIdx=0;	// 채팅창에 내용을 뿌렸을때 마지막에 출력하는 메세지의 고유번호
		
		$(document).ready(function () {
			chatListFunction("ten");	// 처음 chatting 창에 접속 시에 기존 10개의 대화 내용을 출력해 주기 위해 함수 호출
			
			getRepeatChat();	// 주기적으로 채팅 화면을 호출시켜주는 함수
		});
		
		// 페이지를 주기적으로 새로고침 하여 채팅화면을 호출 시켜준다.
		...
		function chatListFunction(listType) {
			$.ajax({
				...
				success:function(data) {
					...
					let parsed=JSON.parse(tempData);	// JSON 자료를 자바 스크립트에서 사용하기 위해서 파싱 처리한다.
					let res=parsed.res;
		...
		// 엔터키를 누르면 바로 전송 처리 / Shift+Enter 는 다음 줄로 이동 처리
              ...
              <div class="row">
                <div class="form-group col-xs-12">
                  ...
                  &nbsp;&nbsp;&nbsp;
                  	...
                  	<input type="radio" name="avatar" value="2" /><img src="./images/avatar2.png" width="22px" class="img-circle"/> &nbsp;
                  	<input type="radio" name="avatar" value="3" /><img src="./images/avatar3.png" width="22px" class="img-circle"/> &nbsp;
                  	<input type="radio" name="avatar" value="4" /><img src="./images/avatar4.png" width="22px" class="img-circle"/> &nbsp;
                  	<input type="radio" name="avatar" value="5" /><img src="./images/avatar5.png" width="22px" class="img-circle"/> &nbsp;
                  	<input type="radio" name="avatar" value="6" /><img src="./images/avatar6.png" width="22px" class="img-circle"/> &nbsp;
                </div>
              </div>
