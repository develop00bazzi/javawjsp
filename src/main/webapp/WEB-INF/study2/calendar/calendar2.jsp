...
<p><br/></p>
<div class="container">
	<h2 class="text-center">달력 연습 2</h2>
	<div class="text-center">
		<button type="button" onclick="location.href='${ctp}/calendar2.st?yy=${yy-1}&mm=${mm}';" class="btn btn-secondary" title="이전 년도">⏪</button>
		<button type="button" onclick="location.href='${ctp}/calendar2.st?yy=${yy}&mm=${mm-1}';" class="btn btn-secondary" title="이전 달">◀</button>
		<font size="5">${yy}년 ${mm+1}월 </font>
		<button type="button" onclick="location.href='${ctp}/calendar2.st?yy=${yy}&mm=${mm+1}';" class="btn btn-secondary" title="다음 달">▶</button>
		<button type="button" onclick="location.href='${ctp}/calendar2.st?yy=${yy+1}&mm=${mm}';" class="btn btn-secondary" title="다음 년도">⏩</button><br/>
		&nbsp;
		<button type="button" onclick="location.href='${ctp}/calendar2.st?';" class="btn btn-secondary" title="오늘 날짜"><i class="fa fa-refresh"></i></button>
	</div>
	<br/>
	<div class="text-center">
		<table class="table table-bordered" stype="height:80pv">
