...
create table member (
	...
	level int default 1,						/* 회원 등급(0:관리자, 1:준회원, 2:정회원 3:우수회원, (4:운영자,매니저) */
...
insert into member values (default,'admin','1234','관리자','관리자',default,default,'010-9885-5460','충북 청주시 서원구 서원서로 27','develop_bazzi@naver.com','https://github.com/develop00bazzi','개발자','사진/영상',default,'관리자입니다.',default,default,default,0,default,default,default,default);
