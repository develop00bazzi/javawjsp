...
<div class="container">
	<form name="myform" method="post" action="${ctp}/boInputOk.bo">
		...
		<table class="table">
			...
			<tr>
				<th>글 제목</th>
				<td><input type="text" name="title" placeholder="글 제목을 입력하세요" autofocus required class="form-control" /></td>
			</tr>
			<tr>
				<th>이메일 주소</th>
			...
			<tr>
				<td colspan="2" class="text-center">
					...
					<input type="button" value="돌아가기" onclick="loacation.href='${ctp}/boList.bo';" class="btn btn-secondary" /> &nbsp;
				</td>
			</tr>
		</table>
