			...
			$.ajax({
				...
				success: function(res) {
					if(res=="1") {
						...
						location.reload();
						/*	
						댓글의 개수가 많아지면 location.reload를 하면 화면이 깜빡이는 경우도 존재해서
						div 태그로 따로 영역을 지정해서 리로드 하는 경우도 있음.	
						*/
					}
					else {
						alert("댓글 입력 실패!");
...
<div class="container">
	...
	<form name="replyForm">
		...
		<!-- aJax로 처리하게 되면 폼 형식으로 자료가 넘어가는 것이 의미가 없어서 주석 처리 해놓은 것이니 다음에 볼때 헷갈리지 말기.. -->
	</form>
